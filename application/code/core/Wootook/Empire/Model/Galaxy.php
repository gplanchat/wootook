 ...
 */
class Wootook_Empire_Model_Galaxy extends Wootook_Core_Entity {

    protected static $_instances = array();
    
    protected static $_singleton = null;

    protected $_eventPrefix = 'galaxy';
    protected $_eventObject = 'galaxy';
    ...
    // TODO à revoir pour changer $this->getIdFieldName() par id_planet
    public static function factoryFromCoords($coords, $type = self::TYPE_PLANET)
    {
        ...
        if ($galaxyData === null || !$galaxyData->getData($this->getIdFieldName())) {
            return new self();
        }

        return self::factory($galaxyData->getData($this->getIdFieldName()));
    }

    protected function _init()
    {
        $this->setIdFieldName('id_planet');
    ...
    {
        return $this->getData('galaxy');
    }

    public function setGalaxy($galaxy)
    {
        return $this->setData('galaxy', $galaxy);
    }
    ...
    {
        return $this->getData('planet');
    }
    
    public function setPlanet($planet)
    {
        $this->setData('planet', $planet);
    }
    
    public function getMetal()
    {
        return $this->getData('metal');
    }
    
    public function setMetal($metal)
    {
        $this->setData('metal', $metal);
    }
    
    public function getCrystal()
    {
        return $this->getData('crystal');
    }
    
    public function setCrystal($crystal)
    {
        $this->setData('crystal', $crystal);
    }
    
    public function getIdLuna() {
        $this->getData('id_luna');
    }
    
    public function setIdLuna($idLuna)
    {
        $this->setData('id_luna', $idLuna);
    }
    
    public function getLuna()
    {
        return $this->getData('luna');
    }
    
    public function setLuna($luna)
    {
        $this->setData('luna', $luna);
    }
